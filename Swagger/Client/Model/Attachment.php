 ...
 *
 * @category Class
 * @description Gets or sets an array of objects in which you can specify any attachments you want to include.
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Attachment implements ModelInterface, ArrayAccess
{
     ...
     * Sets content
     *
     * @param string $content Gets or sets the Base64 encoded content of the attachment.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Gets or sets the mime type of the content you are attaching. For example, application/pdf or image/jpeg.
     *
     * @return $this
     */
     ...
     * Sets filename
     *
     * @param string $filename Gets or sets the filename of the attachment.
     *
     * @return $this
     */
