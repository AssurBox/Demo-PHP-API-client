...
/**
 * GreenCardRequestInfoSummary Class Doc Comment
 *
 * @category Class
 * @description This class represents the part that should be loaded when using GET for a list of requests
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GreenCardRequestInfoSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GreenCardRequestInfoSummary';
