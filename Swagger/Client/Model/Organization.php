 ...
 *
 * @category Class
 * @description An organization is a company that uses AssurBox
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Organization implements ModelInterface, ArrayAccess
{
     ...
     * Sets identifier
     *
     * @param int $identifier Identifier of the organization in AssurBox
     *
     * @return $this
     */
     ...
     * Sets vat
     *
     * @param string $vat VAT number  (International VAT number)
     *
     * @return $this
     */
