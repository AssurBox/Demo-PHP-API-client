...
/**
 * GreenCardRequestResponse Class Doc Comment
 *
 * @category Class
 * @description Contract to be POSTED to the AssurBox&#39;s response endpoint for a green card request
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GreenCardRequestResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GreenCardRequestResponse';
    ...
    protected static $setters = [
        ...
        'has_approval' => 'setHasApproval',
        'approval_reason' => 'setApprovalReason',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['has_approval'] = isset($data['has_approval']) ? $data['has_approval'] : null;
        $this->container['approval_reason'] = isset($data['approval_reason']) ? $data['approval_reason'] : null;
     ...
     * Sets correlation_id
     *
     * @param string $correlation_id The unique identifier for the whole process of the green card request
     *
     * @return $this
     */
     ...
     * Sets message_id
     *
     * @param string $message_id The unique identifier for the current request message
     *
     * @return $this
     */
     ...
     * Sets attachments
     *
     * @param \Swagger\Client\Model\Attachment[] $attachments The green card file and additional files if needed
     *
     * @return $this
     */
     ...
     * Sets communication
     *
     * @param string $communication Some information if wanted
     *
     * @return $this
     */
     ...
     * @return bool
     */
    public function getHasApproval()
    {
        return $this->container['has_approval'];
    }

    /**
     * Sets has_approval
     *
     * @param bool $has_approval Indicates if the green card request was approved
     *
     * @return $this
     */
    public function setHasApproval($has_approval)
    {
        $this->container['has_approval'] = $has_approval;

        return $this;
    }

    /**
     * Gets approval_reason
     *
     * @return string
     */
    public function getApprovalReason()
    {
        return $this->container['approval_reason'];
    }

    /**
     * Sets approval_reason
     *
     * @param string $approval_reason Reason if no approval for the request
     *
     * @return $this
     */
    public function setApprovalReason($approval_reason)
    {
        $this->container['approval_reason'] = $approval_reason;
     ...
     *
     * @param string $response_content Content
     *
     * @return $this
     */
