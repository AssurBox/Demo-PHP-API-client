 ...
 *
 * @category Class
 * @description Reprensents a company
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Company implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
        'vat' => 'string',
        'legal_address' => '\Swagger\Client\Model\Address',
        'representative' => '\Swagger\Client\Model\Person'
    ];
     ...
     * Sets vat
     *
     * @param string $vat VAT of the company (international vat number)
     *
     * @return $this
     */
     ...
     * Sets legal_address
     *
     * @param \Swagger\Client\Model\Address $legal_address Address of the company headquarters
     *
     * @return $this
     */
     ...
     * Sets representative
     *
     * @param \Swagger\Client\Model\Person $representative The person representative for the company
     *
     * @return $this
     */
