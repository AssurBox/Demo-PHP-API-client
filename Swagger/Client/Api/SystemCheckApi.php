...
/**
 * SystemCheckApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class SystemCheckApi
{
     ...
     * Operation echoGet
     *
     * Test if the server gets a message
     *
     * @param  string $id input message (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function echoGet($id)
    {
        list($response) = $this->echoGetWithHttpInfo($id);
        return $response;
    }
     ...
     */
    public function echoGetWithHttpInfo($id)
    {
        $returnType = 'object';
        $request = $this->echoGetRequest($id);
     ...
     */
    public function echoGetAsync($id)
    {
        return $this->echoGetAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function echoGetAsyncWithHttpInfo($id)
    {
        $returnType = 'object';
        $request = $this->echoGetRequest($id);
     ...
     */
    protected function echoGetRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling echoGet'
            );
        }

        $resourcePath = '/api/v1/echo';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
